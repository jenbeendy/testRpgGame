...
CREATE INDEX idx_inventory_items_item_template_id ON inventory_items(item_template_id);
CREATE INDEX idx_recipe_ingredients_recipe_id ON recipe_ingredients(recipe_id);
CREATE INDEX idx_recipe_ingredients_item_template_id ON recipe_ingredients(item_template_id);
CREATE INDEX idx_recipes_result_item_id ON recipes(result_item_id);
CREATE INDEX idx_player_recipes_user_id ON player_recipes(user_id);
CREATE INDEX idx_player_recipes_recipe_id ON player_recipes(recipe_id);
CREATE INDEX idx_crafting_logs_user_id ON crafting_logs(user_id);
CREATE INDEX idx_crafting_logs_recipe_id ON crafting_logs(recipe_id);
